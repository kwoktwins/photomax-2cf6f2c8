...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Photomax — Inspiration Intake" },
      { name: "description", content: "Upload an inspiration photo or describe your aesthetic goal." },
    ],
  }),
  component: InspirationIntake,
});
...
function InspirationIntake() {
  ...
  return (
    <div style={{ maxWidth: 640, margin: "40px auto", padding: "0 20px", fontFamily: "system-ui, sans-serif" }}>
      ...
      {error && (
        <div style={{ marginTop: 16, color: "#b00", fontSize: 14 }}>{error}</div>
      )}
      ...
      {profile && (
        ...
        >
          <h2 style={{ fontSize: 18, marginTop: 0, marginBottom: 12 }}>Target Profile</h2>
